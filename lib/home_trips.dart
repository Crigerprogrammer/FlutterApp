...
import 'package:hola_mundo/description_place.dart';
import 'package:hola_mundo/header_app_bar.dart';
import 'package:hola_mundo/review_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return  Stack(
          children: <Widget>[
            ListView(
              children: <Widget>[
                DescriptionPlace("Guatemala", 5, descriptionDummy),
                ReviewList()
